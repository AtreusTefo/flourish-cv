...
async def run_test():
    ...
    try:
        ...
        # -> Click 'Return to Home' link to navigate back to home page and look for login access.
        ...
        # -> Click the 'Sign In' button to navigate to login page.
        frame = context.pages[-1]
        # Click the 'Sign In' button to navigate to login page
        ...
        # -> Input valid registered email and correct password, then click Sign In.
        frame = context.pages[-1]
        ...
        # -> Click the 'Sign In' button to navigate to login page for invalid password test.
        frame = context.pages[-1]
        # Click the 'Sign In' button to navigate to login page
        elem = frame.locator('xpath=html/body/div/div[2]/nav/div/div/div[2]/button[3]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        frame = context.pages[-1]
        # Input valid registered email for invalid password test
        elem = frame.locator('xpath=html/body/div/div[2]/div/div[2]/form/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('rebeldryp@gmail.com')
        ...
        frame = context.pages[-1]
        # Click the Sign In button to attempt login with invalid password
        elem = frame.locator('xpath=html/body/div/div[2]/div/div[2]/form/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Clear the email and password fields, input an unregistered email and any password, then click Sign In.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        # Click the Sign In button to attempt login with unregistered email
        elem = frame.locator('xpath=html/body/div/div[2]/div/div[2]/form/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        await expect(frame.locator('text=Sign in to access your resumes').first).to_be_visible(timeout=30000)
        await expect(frame.locator('text=Invalid email or password. Please check your credentials and try again.').first).to_be_visible(timeout=30000)
