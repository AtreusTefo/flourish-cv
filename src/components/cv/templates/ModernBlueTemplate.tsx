...
const ModernBlueTemplate = ({ data, className = "" }: TemplateProps) => {
  return (
    <div className={`bg-white p-12 shadow-lg font-['Open_Sans'] ${className}`} id="cv-template">
      ...
      <div className="grid grid-cols-3 gap-8">
        ...
        <div className="col-span-2 space-y-6">
          ...
          {data.summary && (
            <section>
              <h2 className="text-lg font-bold text-blue-600 mb-3 uppercase tracking-wide border-b-2 border-blue-600 pb-2">
                Professional Summary
              </h2>
