...
const BoldModernTemplate = ({ data, className = "", primaryColor = "#DC2626", secondaryColor = "#991B1B" }: TemplateProps) => {
  return (
    <div className={`bg-gray-50 shadow-lg font-['Inter'] ${className}`} id="cv-template">
      {/* Bold Header Section */}
      <div className="p-12 text-white" style={{ background: `linear-gradient(135deg, ${primaryColor}, ${secondaryColor})` }}>
        <div className="flex items-start gap-6">
          ...
          <div className="flex-1">
            <h1 className="text-5xl font-black mb-3 tracking-tight">{data.personalInfo.name}</h1>
            <p className="text-2xl font-light mb-6" style={{ color: primaryColor + "15" }}>{data.personalInfo.jobTitle}</p>
      ...
      <div className="p-12">
        ...
        {data.summary && (
          <section className="mb-10 relative">
            <div className="absolute -left-12 top-0 w-2 h-full rounded-r" style={{ backgroundColor: primaryColor }}></div>
              ...
              <section>
                ...
                <div className="space-y-6">
                  {data.experience.map((exp) => (
                    <div key={exp.id} className="bg-white p-6 rounded-lg shadow-sm border-l-4" style={{ borderColor: primaryColor }}>
                      <div className="flex justify-between items-start mb-3">
                        ...
                        <span className="text-sm font-medium px-4 py-2 rounded-full whitespace-nowrap" style={{ backgroundColor: primaryColor + "15", color: primaryColor }}>
