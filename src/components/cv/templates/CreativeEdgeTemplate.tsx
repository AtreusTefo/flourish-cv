...
const CreativeEdgeTemplate = ({ data, className = "", primaryColor = "#8B5CF6", secondaryColor = "#7C3AED", id = "cv-template" }: TemplateProps) => {
  return (
    <div className={`bg-white shadow-lg font-['Poppins'] flex flex-col md:flex-row ${className}`} id={id}>
      {/* Colored Sidebar */}
      <div className="w-full md:w-1/3 text-white p-6 md:p-8" style={{ background: `linear-gradient(to bottom, ${primaryColor}, ${secondaryColor})` }}>
        {/* Personal Info */}
        <div className="mb-8">
