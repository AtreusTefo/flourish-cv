...
const ModernBlueTemplate = ({ data, className = "", primaryColor = "#3B82F6", secondaryColor = "#1E40AF", id = "cv-template" }: TemplateProps) => {
  return (
    <div className={`bg-white p-6 sm:p-8 md:p-12 shadow-lg font-['Open_Sans'] ${className}`} id={id}>
      {/* Header */}
