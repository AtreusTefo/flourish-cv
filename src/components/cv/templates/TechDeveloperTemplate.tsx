...
const TechDeveloperTemplate = ({ data, className = "", primaryColor = "#06B6D4", secondaryColor = "#0891B2", id = "cv-template" }: TemplateProps) => {
  return (
    <div className={`bg-gray-50 p-6 sm:p-8 md:p-12 shadow-lg font-['Poppins'] ${className}`} id={id}>
      {/* Header with Gradient */}
      <div className="-mx-6 sm:-mx-8 md:-mx-12 -mt-6 sm:-mt-8 md:-mt-12 px-6 sm:px-8 md:px-12 py-6 md:py-8 mb-6 md:mb-8" style={{ background: `linear-gradient(to right, ${primaryColor}, ${secondaryColor})` }}>
