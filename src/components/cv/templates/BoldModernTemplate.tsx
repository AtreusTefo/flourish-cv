  ...
  return (
    <div className={`bg-gray-50 shadow-lg font-['Inter'] ${className}`} id={id}>
      ...
      <div className="p-6 sm:p-8 md:p-12 text-white" style={{ background: `linear-gradient(135deg, ${primaryColor}, ${secondaryColor})` }}>
        <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-lg sm:text-xl md:text-2xl font-light mb-4 sm:mb-6 text-white/80">{data.personalInfo.jobTitle}</p>
      ...
      <div className="p-6 sm:p-8 md:p-12">
        {/* Summary with Accent */}
        {data.summary && (
          <section className="mb-6 sm:mb-8 md:mb-10 pl-4 border-l-4" style={{ borderColor: primaryColor }}>
