...
async def run_test():
    ...
    try:
        ...
        # -> Click the Sign In button to start login process.
        ...
        # -> Update personal information fields with new data.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        # Update Website/Portfolio field
        ...
        # -> Click on the Profile button to navigate to profile management page for avatar upload.
        frame = context.pages[-1]
        # Click Profile button to go to profile management page for avatar upload
        ...
        try:
            ...
            raise AssertionError("Test case failed: The profile update and avatar upload did not complete successfully as per the test plan. Expected confirmation message 'Profile Update Successful' was not found on the page.")
