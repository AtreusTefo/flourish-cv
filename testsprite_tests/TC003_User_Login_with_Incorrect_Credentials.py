...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        # Enter wrong password in password input field
        ...
        # -> Click the Sign In button to submit the login form with invalid credentials and verify error message.
        frame = context.pages[-1]
        ...
        try:
            ...
            raise AssertionError('Test case failed: Login should fail with invalid credentials and display an error message indicating invalid credentials, but the success message was not found.')
