...
const ExecutiveFormalTemplate = ({ data, className = "", primaryColor = "#1F2937", secondaryColor = "#374151", id = "cv-template" }: TemplateProps) => {
  return (
    <div className={`bg-white p-6 sm:p-8 md:p-12 shadow-lg font-['Roboto'] ${className}`} id={id}>
      {/* Header with Gray Background */}
      <div className="-mx-6 sm:-mx-8 md:-mx-12 -mt-6 sm:-mt-8 md:-mt-12 px-6 sm:px-8 md:px-12 py-6 md:py-8 mb-6 md:mb-8 text-white" style={{ backgroundColor: primaryColor }}>
