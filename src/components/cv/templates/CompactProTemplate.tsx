...
const CompactProTemplate = ({ data, className = "", primaryColor = "#059669", secondaryColor = "#047857", id = "cv-template" }: TemplateProps) => {
  return (
    <div className={`bg-white shadow-lg font-['Lato'] flex ${className}`} id={id}>
